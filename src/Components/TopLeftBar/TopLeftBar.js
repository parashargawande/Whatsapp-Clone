...
const TopLeftBar = (props) => {
    console.log('[TopLeftBar.js] rendered');
    console.log(props);
    return <div className="TopLeft-Bar-Container">
        <div className="Left-Section">
            <div onClick={props.showUserProfile} className="Profile-Image">
            ...
            {/* <div className='Profile-name'>{props.user.email}</div> */}
        </div>
        <div className="Right-Section">
            <div className="icon-container">
                <i className="ms-Icon ms-Icon--StatusCircleRing" aria-hidden="true"></i>
            </div>
            <div className="icon-container">
                <i className="ms-Icon ms-Icon--CannedChat" aria-hidden="true"></i>
            </div>
            <div onClick={() => props.setShowMenu(!props.showMenu)} className={props.showMenu ? "icon-container active" : "icon-container"}>
