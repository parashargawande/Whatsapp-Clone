        ...
        {props.openedChat ?
            <div className='TopRightBar-container'>
                ...
                <div className='Group-info-container'>
                    <div className="Group-Title">{props.openedChat.title}</div>
                    <div className="Group-Description">{ props.openedChat.title}</div>
                </div>
                <div className='Group-more-icons'>
            ...
            <div className='TopRightBar-container'></div>
        }
    </React.Fragment>
}
